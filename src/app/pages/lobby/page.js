                ...
                <div className = "flex flex-col justify-center items-center mt-10 mb-28">
                      <div className ="row">
                        <div className = "column">
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Team 1 </button>
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Team 2 </button>
                        </div>
                        <div className = "column">
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Player 1 </button>
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Player 2 </button>
                        </div>
                        <div className = "column">
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Rotate </button>
                        </div>
                        <div className = "column">
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Player 3</button>
                          <button id = "button" className = "bg-blue-200 rounded-full text-3xl font-bold"> Player 4 </button>
                        </div>
                      </div> 
                    </div>
